...
class ThemesPullLatestRevCommand extends Command
{
    public function __construct(private ThemeListService $pluginListService)
    {
        parent::__construct();
    }
    ...
    {
        $this->setName('themes:pull-latest-rev')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('Getting latest theme revision...');
